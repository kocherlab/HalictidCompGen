...
genome=/Genomics/kocherlab/berubin/assembly/hic/APUR/APUR_genome_v2.0.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
pred_gff=round_1_output_brakerpred/ipr_hits.gff3 #ab-initio predictions from an external GFF3 file
model_gff=round_1_output_brakerpred/APUR_genes.gff3 #annotated gene models from an external GFF3 file (annotation pass-through)
